<div class="fileLocations view">
<h2><?php  echo __('File Location');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($fileLocation['FileLocation']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('File Location Name'); ?></dt>
		<dd>
			<?php echo h($fileLocation['FileLocation']['file_location_name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('File Location Status'); ?></dt>
		<dd>
			<?php echo h($fileLocation['FileLocation']['file_location_status']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit File Location'), array('action' => 'edit', $fileLocation['FileLocation']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete File Location'), array('action' => 'delete', $fileLocation['FileLocation']['id']), null, __('Are you sure you want to delete # %s?', $fileLocation['FileLocation']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($fileLocation['FileDocument'])):?>
	...
	<?php
		$i = 0;
		foreach ($fileLocation['FileDocument'] as $fileDocument): ?>
		<tr>
