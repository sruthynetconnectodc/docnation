<div class="filePaths view">
<h2><?php  echo __('File Path');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($filePath['FilePath']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('File Path Name'); ?></dt>
		<dd>
			<?php echo h($filePath['FilePath']['file_path_name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('File Path Location'); ?></dt>
		<dd>
			<?php echo h($filePath['FilePath']['file_path_location']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('File Path Status'); ?></dt>
		<dd>
			<?php echo h($filePath['FilePath']['file_path_status']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit File Path'), array('action' => 'edit', $filePath['FilePath']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete File Path'), array('action' => 'delete', $filePath['FilePath']['id']), null, __('Are you sure you want to delete # %s?', $filePath['FilePath']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($filePath['FileDocument'])):?>
	...
	<?php
		$i = 0;
		foreach ($filePath['FileDocument'] as $fileDocument): ?>
		<tr>
